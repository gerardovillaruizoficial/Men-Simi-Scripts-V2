...
openButton.Size = UDim2.new(0, 40, 0, 40) -- más pequeño para celulares
...
mainFrame.Size = UDim2.new(0, 160, 0, 260) -- más compacto
...
-- Función para crear botones ON/OFF adaptados a celulares
local function createToggleButton(name, posY, stateVar, callback)
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(1, -20, 0, 30) -- más pequeño
...
createToggleButton("Noclip", 60, function() return noclipEnabled end, function()
    noclipEnabled = not noclipEnabled
end)

createToggleButton("Speed Boost", 100, function() return speedEnabled end, function()
    speedEnabled = not speedEnabled
    humanoid.WalkSpeed = speedEnabled and 100 or 16
end)

createToggleButton("Jump Boost", 140, function() return jumpEnabled end, function()
    jumpEnabled = not jumpEnabled
    humanoid.JumpPower = jumpEnabled and 200 or 50
end)

createToggleButton("God Mode", 180, function() return godEnabled end, function()
    godEnabled = not godEnabled
end)

createToggleButton("Mejorador de FPS", 220, function() return fpsBoostEnabled end, function()
